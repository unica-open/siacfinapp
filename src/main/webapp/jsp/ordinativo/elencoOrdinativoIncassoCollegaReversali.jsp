	...
	<div class="row-fluid">
		<div class="span12 ">
			<div class="contentPage"> 
				...
				<s:form id="mainForm" method="post" action="elencoOrdinativoIncassoCollegaReversali">  
        		...
        		<p class="marginLarge"> 
				 ...
				 <!--task-131 <s:submit cssClass="btn btn-primary pull-right" method="collegaReversali" value="collega reversali" id="collegaReversali"/> --> 
				 <s:submit cssClass="btn btn-primary pull-right" action="elencoOrdinativoIncassoCollegaReversali_collegaReversali" value="collega reversali" id="collegaReversali"/>
		  		</p>  	                                 
		      </s:form>
      	</div>	
    </div>	
