...
<div class="row-fluid">
	...
	<div class="step-content"> 
		...
		<h4>Coperture</h4>
		   ...
		   <display:table name="gestioneOrdinativoStep3Model.listaCoperture"  class="table tab_left table-hover" summary="riepilogo provv"
					 ...
					 <display:column>
					  ...
					  <ul class="dropdown-menu pull-right">
					  	<li><a id="linkAggiorna_<s:property value="%{#attr.tabCopertureID.idProvvisorioDiCassa}"/>" href="#aggProvvisorioCassa" data-toggle="modal" class="linkAggiornaCopertura">aggiorna</a>
						<li><a id="linkElimina_<s:property value="%{#attr.tabCopertureID.idProvvisorioDiCassa}"/>" href="#msgEliminaProvvisorio" data-toggle="modal" class="linkEliminaProvvisorio">elimina</a>
					  </ul>
					</div>
					 </display:column>	
		...
		<s:else>
		   <display:table name="gestioneOrdinativoStep3Model.listaCoperture"  class="table tab_left table-hover" summary="riepilogo provv"
			...
			<p><a id="puntoQui" class="btn"  data-toggle="collapse" data-target="#insProvvisorioTable">inserisci provvisorio</a></p>  
                                           
			<div id="insProvvisorioTable" class="collapse">
				<div class="accordion_info"> 
					<div class="step-pane active" id="step1"> 
						<p><a class="btn btn-primary pull-right" href="#RicProvvisorio" data-toggle="modal">cerca provvisorio</a></p>  
						<br>
							<a id="ancoretta"></a>
							<h4>Elenco Provvisori <i>(risultato della ricerca)</i></h4>
							   <fieldset>
							   <s:if test="oggettoDaPopolarePagamento()">
							   <!-- ORDINATIVO PAGAMENTO --> 
							   <display:table name="gestioneOrdinativoStep3Model.listaProvvisori"  class="table tab_left table-hover" summary="riepilogo provv"
 										      requestURI="gestioneOrdinativoPagamentoStep3.do" 
 											  uid="tabElProvvOrdinativiID" pagesize="10" keepStatus="true" clearStatus="${clearStatus}"> 
								...
								<span class="btnSelezionaVisible">
<!-- 								<p> -->
...
<!-- 							    </p> -->
								...
								<div id="aggiornaRegolaProvv">
									<s:include value="/jsp/ordinativo/include/regolaProvvisorio.jsp" />
								</div>
                    ...
                    <div id="aggiornaBottoniera">
                    	<s:include value="/jsp/ordinativo/include/aggiornaBottoniera.jsp" />	             
					</div>	
...
<!--modale consulta RicProvvisorio -->
  <div id="RicProvvisorio" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="RicProvvisorioLabel" aria-hidden="true">
	...
	<div class="modal-body">
		...
		<fieldset class="form-horizontal">        		 
			<div class="control-group">
				...
				<div class="controls">   
					<span class="al">
					  <label class="radio inline" for="DaAnno">Anno </label>
					</span>
					<s:textfield name="ricercaProvvisorioModel.annoProvvisorioDa" id="annoDa" cssClass="lbTextSmall span2 soloNumeri" maxlength="4"  />
					
					<span class="al">
					  <label class="radio inline" for="DaNum">Numero </label>
					</span>
					<s:textfield name="ricercaProvvisorioModel.numeroProvvisorioDa" id="numeroDa" cssClass="lbTextSmall span2 soloNumeri" maxlength="15"   />
			...
			<div class="control-group">
				...
				<div class="controls">   
					<span class="al">
					  <label class="radio inline" for="AAnno">Anno </label>
					</span>
					<s:textfield name="ricercaProvvisorioModel.annoProvvisorioA" id="annoA" cssClass="lbTextSmall span2 soloNumeri" maxlength="4"  />
					
					<span class="al">
					  <label class="radio inline" for="ANum">Numero </label>
					</span>
					<s:textfield name="ricercaProvvisorioModel.numeroProvvisorioA" id="numeroA" cssClass="lbTextSmall span2 soloNumeri" maxlength="15"    />
			...
			<div class="control-group">
				...
				<div class="controls">   
					<span class="alLeft">
					  <label class="radio inline" for="EmissioneDa">Da </label>
					</span>
					<s:textfield name="ricercaProvvisorioModel.dataInizio" id="dataEmissioneDa" cssClass="lbTextSmall span2" maxlength="10"   />
					
					<span class="marginLeft4"></span>
					<span class="al">
					  <label class="radio inline" for="EmissioneA">A </label>
					</span>
...
<%-- 					</span>	 --%>
			...
			<div class="control-group">
				...
				<div class="controls">   
					...
					<s:textfield name="ricercaProvvisorioModel.importoDa" id="importoDa" cssClass="span2 soloNumeri decimale" onkeypress="return checkItNumbersCommaAndDotOnly(event)" maxlength="12" />
					
					<span class="marginLeft4"></span>
					<span class="al">
					  <label class="radio inline" for="ImportoA">A </label>
					</span>
					<s:textfield name="ricercaProvvisorioModel.importoA" id="importoA" cssClass="span2 soloNumeri decimale" onkeypress="return checkItNumbersCommaAndDotOnly(event)" />
			...
			<!-- SIAC-6356 -->		
						...
						<div class="control-group">
							...
							<div class="controls">
								<s:select list="gestioneOrdinativoStep3Model.listaContoTesoriere" id="listacontoTesoriere" headerKey=""  
									headerValue="" name="ricercaProvvisorioModel.contoTesoriere" cssClass="span4" 
  ...
  <div class="modal-footer">
 	 <s:submit id="cercaProvvisorioSubmit" name="cerca" value="conferma"	method="cercaProvvisorio" cssClass="btn btn-primary" />
	...
	<!--#include virtual="include/modal.html" -->    
        ...
        <p class="margin-medium"> <s:include value="/jsp/include/indietro.jsp" />    
			...
			<s:if test="!sonoInAggiornamentoOR()">
			  <s:submit id="salvaProvv" name="salva" value="salva" method="salvaProvvisori" cssClass="btn btn-primary freezePagina" />
			</s:if>  
			<s:else>
				<s:if test="sonoInAggiornamento()">
					<s:submit id="aggiornaProv" name="salva" value="salva" method="aggiornaOrdinativo" cssClass="btn btn-primary freezePagina" />
				</s:if>
				<s:elseif test="sonoInAggiornamentoIncasso()">
					<s:submit id="aggiornaProv" name="salva" value="salva" method="aggiornaOrdinativoIncasso" cssClass="btn btn-primary freezePagina" />
				</s:elseif>
			</s:else>
<!-- 				<a class="btn btn-primary" href="FIN-AggOrdinativoStep1.shtml">salva</a> -->
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$(".radioProvvCassa").change(function(){
			$.ajax({
				url: '<s:url method="selezionaProvvisorio"/>',
				type: 'POST',
			    ...
			    success: function(data)  {
				    ...
				    // paolo
				    $.ajax({
						url: '<s:url method="aggiornaBottoniera"></s:url>',
						type: "GET",
					    success: function(data)  {
		...
		$(".linkAggiornaCopertura").click(function() {
			...
			$.ajax({
				url: '<s:url method="dettaglioAggiornaCoperture"/>',
				type: 'POST',
