			...
			<div class="accordion-group">
				<div class="accordion-heading">
					<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#modPAG" href="#modTAB">
						...
						<s:if test="modPagamentoObbligatoria">
						...
						<s:if test="!modPagamentoObbligatoria">
                         ...
                         <s:if test="modpagamentoSelezionata!=null">
							: <s:property value="modpagamentoSelezionata.modalitaAccreditoSoggetto.codice"/> - <s:property value="modpagamentoSelezionata.modalitaAccreditoSoggetto.descrizione"/> 
						 </s:if>
				...
				<div id="modTAB" class="accordion-body collapse">
					<div class="accordion-inner">
						<fieldset class="form-horizontal">	
							<display:table name="listaModalitaPagamentoVisualizza" class="table table-hover tab_left" summary="riepilogo modalita pagamento" uid="modalitaPagamentoSupport">
						       
						        <display:column>
						       		<s:radio id="checkMdp" list="%{#attr.modalitaPagamentoSupport.uid}" cssClass="idModCreditore" name="radioModPagSelezionato" theme="displaytag" disabled="disableAggiornaRiga()"></s:radio>
						        </display:column>
							    ...
							    <display:column title="Modalit&agrave;">
							    	...
							    	data-content="${attr.modalitaPagamentoSupport.descrizioneFormattata}">${attr.modalitaPagamentoSupport.modalitaAccreditoSoggetto.codice}&nbsp;-&nbsp;${attr.modalitaPagamentoSupport.modalitaAccreditoSoggetto.descrizione}
							    	</a>  --%>
