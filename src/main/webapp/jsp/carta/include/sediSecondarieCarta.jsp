				...
				<div id="sediTAB" class="accordion-body collapse">
					<div class="accordion-inner">
						<fieldset class="form-horizontal">					
							<display:table name="listaSediSecondarie" class="table table-hover tab_left" summary="riepilogo indirizzo" uid="sediSec" >
							        <display:column>
							       		<s:radio id="checkSedi" list="%{#attr.sediSec.uid}" cssClass="idSedeCreditore" name="radioSediSecondarieSoggettoSelezionato" theme="displaytag" disabled="disableAggiornaRiga()"></s:radio>
							        </display:column>
		...
		function ricaricaSediModPag (caricaTitolo) {
			...
			if(caricaTitolo){
		        ...
		        $.ajax({
					...
					url: '<s:url action="%{#remodpagamentoAction}"/>',
					type: "POST",
					data: data, 
