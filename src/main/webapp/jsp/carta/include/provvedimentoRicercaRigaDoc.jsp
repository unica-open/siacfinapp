...
<fieldset class="form-horizontal">
	<div class="control-group">
      ...
      <s:textfield id="annoProvvedimento" cssClass="lbTextSmall span1" maxlength="4" name="provvedimento.annoProvvedimento" onkeyup="return checkItNumbersOnly(event)" disabled="provvedimentoSelezionato"></s:textfield>     
			<span class="al">
				<label class="radio inline" >Numero </label>
			</span>
      <s:textfield id="numeroProvvedimento" cssClass="lbTextSmall span1" maxlength="6" name="provvedimento.numeroProvvedimento" onkeyup="return checkItNumbersOnly(event)" disabled="provvedimentoSelezionato"></s:textfield>     
			<span class="al">
	  ...
	  <s:select list="listaTipiProvvedimenti" id="listaTipiProvvedimenti"
			       ...
			       headerKey="" headerValue=""  
       	 	       ...
       	 	       disabled="provvedimentoSelezionato" /> 
...
<%--            		     </span>  --%>
           		...
           		<i class="icon-spin icon-refresh spinner" id="spinnerStruttAmmOrdinativoIncasso">
                </i>
          </a>
         </div>
