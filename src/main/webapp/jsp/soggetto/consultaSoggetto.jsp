...
<div class="tab-pane active" id="soggetto">
	...
	<h4>Stato: <s:property value="dettaglioSoggetto.statoOperativo"/>
	<s:if test="dettaglioSoggetto.notaStatoOperativo != null"> - <s:property value="dettaglioSoggetto.notaStatoOperativo"/></s:if>   
	</h4>
	...
	<div class="boxOrSpan2">
	    <div class="boxOrInLeft">
	        ...
	        <ul class="htmlelt">
			    ...
			    <li>
			    <dfn>Canale PA/PRIVATI</dfn>
			    <dl><s:property value="dettaglioSoggetto.canalePA"/>&nbsp;</dl>
			    </li>
			     <li>
			    <dfn>Codice Destinatario/IPA</dfn>
			    <dl><s:property value="dettaglioSoggetto.codDestinatario"/>&nbsp;</dl>
			    </li>
			     <li>
			    <dfn>Email PEC</dfn>
			    <dl><s:property value="dettaglioSoggetto.emailPec"/>&nbsp;</dl>
			    </li>
			    <li>
			    <dfn>Matricola</dfn>
			    ...
			    <dl><s:property value="dettaglioSoggetto.note"/>&nbsp;</dl>
			   	...
			   	<li>
			   	<dfn>Classificazione</dfn>
			    <dl><s:property value="classiFormattate"/>&nbsp;</dl>
			    </li>
			    <li>
			    <dfn>Oneri</dfn>
				<dl><s:property value="oneriFormattati"/>&nbsp;</dl>
				</li>

			    <s:if test="dettaglioSoggetto.tipoSoggetto.soggettoTipoCode != 'PF'">
<!-- 			    <li> -->
<!-- 			    <dfn>Login inserimento DURC</dfn> -->
<%-- 			    <dl><s:property value="%{dettaglioSoggetto.loginInserimentoDurc}"/>&nbsp;</dl> --%>
<!-- 				</li> -->

			    <li>
			    <dfn>Login modifica DURC</dfn>
			    <dl><s:property value="%{dettaglioSoggetto.loginModificaDurc}"/>&nbsp;</dl>
				</li>

			    <li>
			    <dfn>Data fine validit&agrave; DURC</dfn>
			    <dl><s:property value="%{dettaglioSoggetto.dataFineValiditaDurc}"/>&nbsp;</dl>
				</li>
			    <li>
			    <dfn>Fonte DURC</dfn>
			    <dl><s:property value="dettaglioSoggetto.descrizioneFonteDurc"/>&nbsp;</dl>
				</li>
			    <li>
			    <dfn>Note DURC</dfn>
			    <dl><s:property value="dettaglioSoggetto.noteDurc"/>&nbsp;</dl>
				</li>
				</s:if>
...
<div class="tab-pane" id="sedi">
   <h4>Sedi secondarie</h4>
    <display:table name="sediSecondarie" class="table tab_left table-hover" summary="riepilogo indirizzo" requestURI="elencoSoggetti.do" uid="sedeSecondariaSupportID">
	  	<display:column title="Denominazione" property="denominazione" />
	  	<display:column title="Indirizzo">
	  		<s:property value="#attr.sedeSecondariaSupportID.indirizzoSoggettoPrincipale.sedime" /> 
		 	<s:property value="#attr.sedeSecondariaSupportID.indirizzoSoggettoPrincipale.denominazione" />
		 	<s:property value="#attr.sedeSecondariaSupportID.indirizzoSoggettoPrincipale.numeroCivico" />,
			<s:property value="#attr.sedeSecondariaSupportID.indirizzoSoggettoPrincipale.cap" />
	  	</display:column>
	  	...
	  	<display:column title="" class="tab_Right" >
		     ...
		     <div class="btn-group">
				...
				<ul class="dropdown-menu pull-right">
					<li><a style="position: fixed" href="#" class="consultaSedeSecondaria"  id="consulta_<s:property value="#attr.sedeSecondariaSupportID.uid" />">consulta</a></li>
				</ul>
			</div>
		 </display:column>	
...
<div class="tab-pane" id="modalita">
  ...
  <display:table name="modalitaPagamento" class="table tab_left table-hover margin-large" summary="riepilogo modalita pagamento" requestURI="elencoSoggetti.do" uid="sedeSupport">
       ...
       <%--  PRIMA:
	    ...
	    <display:column title="Modalit&agrave;">
	    	<%--${attr.sedeSupport.descrizioneInfo.descrizioneArricchita}--%>
	    	
	    	  <a data-html="true" href="#" data-trigger="hover" rel="popover" data-container="#modTAB" 
							    	title="${attr.sedeSupport.modalitaAccreditoSoggetto.codice}&nbsp;-&nbsp;${attr.sedeSupport.modalitaAccreditoSoggetto.descrizione}" 
							    	data-content="${attr.sedeSupport.descrizioneForPopOver}">${attr.sedeSupport.descrizioneInfo.descrizioneArricchita}</a>
