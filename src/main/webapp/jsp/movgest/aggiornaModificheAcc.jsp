...
<iframe src="siac_iframe.htm" name="iframe_a"width="98%" height="600px" frameborder="0"></iframe> -->
	...
	<div class="container-fluid">
		...
		<!-- 	<h3>
				...
				<s:form id="mainForm" method="post" action="aggiornaMovSpesaAcc.do"
								...
								<div class="control-group">
									<div class="controls">
										<dl class="dl-horizontal">
											...
											<s:if
												test="%{importoNewFormatted != null && importoNewFormatted.trim() != ''}">
												<dt>Nuovo Importo</dt>
...
<%-- 						                          		</s:if> --%>
								...
								<div class="control-group">
									...
									<div class="controls">
										<s:textfield name="descrizione" id="descrizione"
											cssClass="span9" />
									</div>
								</div>
							</fieldset>
...
<%-- 							<s:include value="/jsp/movgest/include/provvedimentoAggiorna.jsp" /> --%>
							...
							<p>
								...
								<span class="pull-right"><s:submit method="salva" value="Salva"
