...
<fieldset class="form-horizontal">
    ...
    <div class="controls">
      ...
      <s:if test="oggettoDaPopolareImpegno()">
     	...
     	<s:if test="null!=listaTipiImpegno">
	      	<s:select list="listaTipiImpegno" id="listaTipiImpegno"  name="step1Model.tipoImpegno" cssClass="span5"  
  ...
  <div class="control-group">
    ...
    <div class="controls">    
      ...
      &nbsp; <s:textfield id="annoImpRiacc" name="step1Model.annoImpRiacc" onkeyup="return checkItNumbersOnly(event)" cssClass="span1 " title="Anno" />&nbsp;
      <s:textfield id="numImpRiacc" cssClass="lbTextSmall span2 " onkeyup="return checkItNumbersOnly(event)" title="Numero" name="step1Model.numImpRiacc"/>
      </span>
    </div>
  </div>
    ...
    <div class="controls">    
      ...
      <s:if test="isAbilitatoGestisciImpegno()"> 
      	 <span class="liqPerPrenotazioneVisibile" id="bloccoPrenotatoLiquidabile">
	     	...
	     	<s:checkbox id="prenotatoLiquidabileCheckBox" name="step1Model.prenotazioneLiquidabile" onclick="impostaValorePrenotatoLiquidabile()"/>
	      </span>
      </s:if> 
    </div>
  </div>
