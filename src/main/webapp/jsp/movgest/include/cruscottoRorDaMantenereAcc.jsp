...
<s:if test="isInInserimento()">
    ...
    <div class="control-group">
        ...
        <div class="control-group">
            ...
            <s:checkbox name="checkDaMantenere" disabled="disabledDaMantenere" fieldValue="true" style="margin-left: 10px;" id="daMantenereValue"/>
        </div>
        ...
        <div class="control-group">
            <div class="controls" style="margin-bottom: 10px;">
                ...
                <s:select list="motiviRorMantenimento" id="listaSintesiMotiviDaMantenere" headerKey="" 
                        headerValue=""  listKey="key" listValue="sintesi"  cssClass="span3" name="rorDaMantenere.valoreSintesi" disabled="disabledDaMantenere"/>
                <s:textarea type="text"  name="rorDaMantenere.descrizione" disabled="disabledDaMantenere"  id="descrizioneMotivoRorDaMantenere" class="span5" style="resize: none; height: 30px;"/>
        ...
        <s:else>
            <div class="control-group">
                ...
                <div class="controls" style="margin-bottom: 10px;">
                    <s:select list="motiviRorMantenimento" id="listaSintesiMotiviDaMantenere" headerKey="" 
                        headerValue=""  listKey="key" listValue="sintesi"  cssClass="span3" name="rorDaMantenere.valoreSintesi" disabled="disabledDaMantenere" />
                    <s:textarea type="text"  name="rorDaMantenere.descrizione" value="%{descrizione}" disabled="disabledDaMantenere" id="descrizioneMotivoRorDaMantenere" class="span5" style="resize: none; height: 30px;"/>
...
<%-- SIAC-8268 --%>
<s:hidden name="disabledDaMantenere" value="%{disabledDaMantenere}"/>
<%-- SIAC-8268 --%>