...
<s:if test="isInInserimento()">
    <div class="control-group">
        ...
        <div class="control-group">
            <div class="controls" style="margin-bottom: 10px;">
                <s:textfield type="text" maxlength="30" onblur="checkNullToEmptyString(event)" name="rorCancellazioneInesigibilita.importo"  id="inputCancellazioneInesegibilita" placeholder="0.00" class="span3 soloNumeri decimale" />&nbsp;
    ...
    <div class="control-group">
        ...
        <div class="control-group">
            <div class="controls" style="margin-bottom: 10px;">
                <s:textfield type="text" maxlength="30" onblur="checkNullToEmptyString(event)" name="rorCancellazioneInsussistenza.importo"  id="inputCancellazioneInsussistenza" placeholder="0.00" class="span3 soloNumeri decimale" />&nbsp;
...
<s:else>
    <div class="control-group">
                    ...
                    <div class="control-group">
                        <div class="controls" style="margin-bottom: 10px;">
                           <%-- SIAC-7773  FL 18/09/2020 importi allargati --%>
                            <s:textfield type="text" maxlength="30" onblur="checkNullToEmptyString(event)" name="listaModificheRor[%{#incr.index}].importoOld" value="%{importoOld}"  id="inputCancellazioneInesegibilita" placeholder="0.00" class="span2 soloNumeri decimale" />&nbsp;
                            <s:select list="motiviRorCancellazione" id="listaSintesiMotiviCancellazioneInesegibilita" headerKey="" 
                        headerValue=""  listKey="key" listValue="sintesi"  cssClass="span4" name="rorCancellazioneInesigibilita.valoreSintesi"/>
        ...
        <s:else>
            <div class="controls" style="margin-bottom: 10px;">
                <s:textfield type="text" maxlength="30" name="rorCancellazioneInesigibilita.importo" onblur="checkNullToEmptyString(event)" id="inputCancellazioneInesegibilita" placeholder="0.00" class="span2 soloNumeri decimale" />&nbsp;
                <s:select list="motiviRorCancellazione" id="listaSintesiMotiviCancellazioneInesegibilita" headerKey="" 
                        headerValue=""  listKey="key" listValue="sintesi"  cssClass="span4" name="rorCancellazioneInesigibilita.valoreSintesi"/>
        ...
        <s:if test="getInsussistenzaRor()">
            <s:iterator value="listaModificheRor"  status="incr" >
                <s:if test='%{listaModificheRor[#incr.index].tipoModificaMovimentoGestione.equals("INSROR")}'>
                    <div class="control-group">
                        <div class="controls" style="margin-bottom: 10px;">
                            <s:textfield type="text" maxlength="30" onblur="checkNullToEmptyString(event)" name="listaModificheRor[%{#incr.index}].importoOld" value="%{importoOld}" placeholder="0.00" class="span2 soloNumeri decimale" />&nbsp;
                            <s:select list="motiviRorCancellazione" id="listaSintesiMotiviCancellazioneInsussistenza" headerKey="" 
