...
<fieldset class="form-horizontal">
  <div class="control-group">
    ...
    <div class="controls">   
      <s:textfield id="annoProvvedimento" cssClass="lbTextSmall span1" maxlength="4" name="provvedimento.annoProvvedimento" onkeyup="return checkItNumbersOnly(event)" disabled="checkProvvedimentoStato()"></s:textfield>     
      <span class="al">
        <label class="radio inline" for="numeroProvvedimento">Numero </label>
      </span>
      <s:textfield id="numeroProvvedimento" cssClass="lbTextSmall span2" maxlength="6" name="provvedimento.numeroProvvedimento" onkeyup="return checkItNumbersOnly(event)" disabled="checkProvvedimentoStato()"></s:textfield>      
      <span class="al">
