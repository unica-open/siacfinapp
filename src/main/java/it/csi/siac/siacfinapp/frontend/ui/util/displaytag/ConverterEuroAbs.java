 ...
 *
 */
public class ConverterEuroAbs implements DisplaytagColumnDecorator {
	...
	public Object decorate(Object columnValue, PageContext pageContext, MediaTypeEnum media) throws DecoratorException {
		try {
			if (columnValue != null) {
				columnValue = ConverterEuroAbs.conversione(columnValue);
			}
		} catch (Exception nfe) {
			// Nulla da fare
		}
	...
	public static Object conversione(Object columnValue){
		if (columnValue != null) {
			...
			columnValue = dFormat.format(((BigDecimal)columnValue).abs());
		}
		return columnValue;
	}
}